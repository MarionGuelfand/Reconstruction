...
#define N_ANTENNA_DATA 10
       ...
       // + Cherenkov_angle_value + eta_value  (M 14/08/2024)
       // + AmpRecons (_adf) = omega_value (M 25/08/2024)
...
#define MAX_CHERENKOV_VALUE 300
...
public:
  ...
  std::vector<double>& Cherenkov_angle_vector() { return _Cherenkov_angle_vector; }
  std::vector<double>& eta_vector() { return _eta_vector; }
  std::vector<double>& adf_vector() { return _adf_vector; }
  std::vector<double>& omega_vector() { return _omega_vector; }

  void Cherenkov_value();

private:
  PORT_i		_xPORT; // C++ interface to the FORTRAN minimiser

  std::vector<double> _Cherenkov_angle_vector;
  std::vector<double> _eta_vector;
  std::vector<double> _adf_vector;
  std::vector<double> _omega_vector;
