...
if use_examples:
    ...
    ANTENNA_FILE = os.path.join(data_dir, "_gp13_65_rtksort.txt")
    root_paths = [
        os.path.join(data_dir, 'August_2025'),
        os.path.join(data_dir, 'September_2025')
    ]
    month_names = [ 'August', 'September']
